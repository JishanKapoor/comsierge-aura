    ...
    <div className="min-h-screen bg-background flex">
      ...
      <div className="w-full lg:w-1/2 flex flex-col justify-center px-6 md:px-12 lg:px-16 py-12">
        ...
        >
          ...
          <Link to="/" className="text-2xl font-medium tracking-tight text-foreground block mb-10">
            comsierge.
          </Link>
          ...
          <form onSubmit={handleSubmit} className="mt-8 space-y-4">
            {!isLogin && (
              ...
              >
                ...
                <input
                  ...
                  className="w-full px-4 py-3 bg-card border border-border rounded-lg text-foreground placeholder:text-muted-foreground/50 focus:outline-none focus:border-foreground/30 transition-colors text-sm"
            ...
            <button
              type="submit"
              className="w-full mt-4 pill-button justify-center py-3"
            >
          ...
          <button className="w-full mt-6 pill-button-ghost justify-center py-2.5 text-sm">
      ...
      >
        ...
        <div 
          ...
          style={{
            background: "linear-gradient(135deg, hsl(0 0% 3% / 0.6) 0%, hsl(0 0% 3% / 0.3) 100%)"
          }}
        />
