    ...
    <div className="min-h-screen bg-background relative">
      ...
      <div className="relative z-10 min-h-screen flex items-center justify-center px-4 sm:px-6 py-12">
        <div className="w-full max-w-md">
          ...
          <Link to="/" className="flex items-center gap-2 text-xl sm:text-2xl font-medium tracking-tight text-foreground mb-8 sm:mb-10">
          ...
          <div className="bg-card/50 backdrop-blur-sm border border-border/50 rounded-2xl p-6 sm:p-8">
              ...
              {!isLogin && (
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-3 sm:px-4 py-2.5 sm:py-3 bg-background border border-border rounded-lg text-foreground placeholder:text-muted-foreground/50 focus:outline-none focus:border-foreground/30 transition-colors text-sm"
            ...
            <button className="w-full mt-5 sm:mt-6 pill-button-ghost justify-center py-2 sm:py-2.5 text-sm">
