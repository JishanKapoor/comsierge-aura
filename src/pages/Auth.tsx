    ...
    <div className="min-h-screen relative overflow-hidden">
      ...
      <div className="relative z-10 min-h-screen flex items-center justify-center px-4 sm:px-6 py-12">
        <div className="w-full max-w-md">
          ...
          {/* Glass Card */}
          <div className="bg-card/40 backdrop-blur-xl border border-white/10 rounded-3xl p-6 sm:p-8 shadow-2xl">
            ...
            <form onSubmit={handleSubmit} className="mt-6 sm:mt-8 space-y-3 sm:space-y-4">
              {!isLogin && (
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-3 sm:px-4 py-2.5 sm:py-3 bg-background/50 backdrop-blur-sm border border-white/10 rounded-xl text-foreground placeholder:text-muted-foreground/50 focus:outline-none focus:border-white/20 transition-colors text-sm"
              ...
              <button
                type="submit"
                className="w-full mt-4 pill-button justify-center py-2.5 sm:py-3"
              >
            ...
            <button className="w-full mt-5 sm:mt-6 bg-white/5 backdrop-blur-sm border border-white/10 rounded-xl py-2.5 sm:py-3 text-sm text-foreground hover:bg-white/10 transition-colors flex items-center justify-center gap-2">
