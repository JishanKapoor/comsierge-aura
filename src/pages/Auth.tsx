    ...
    <div className="min-h-screen relative overflow-hidden bg-background">
      ...
      <div className="absolute inset-0 z-0">
        <img 
          src={heroImage}
          alt="New York City"
          className={`w-full h-full object-cover brightness-125 transition-opacity duration-700 ${imageLoaded ? 'opacity-100' : 'opacity-0'}`}
        />
      ...
      <div className="relative z-10 min-h-screen flex flex-col items-center justify-center px-4 sm:px-6 py-8 sm:py-12">
        ...
        <div className="w-full max-w-md mb-6 sm:mb-8">
          <Link to="/" className="flex items-center justify-center gap-2.5 text-xl sm:text-2xl font-medium tracking-tight text-foreground">
        ...
        <div className="w-full max-w-md bg-card/40 backdrop-blur-xl border border-white/10 rounded-3xl p-6 sm:p-8 shadow-2xl">
          ...
          <button className="w-full mt-5 sm:mt-6 bg-white/5 backdrop-blur-sm border border-white/10 rounded-xl py-2.5 sm:py-3 text-sm text-foreground hover:bg-white/10 transition-all duration-300 flex items-center justify-center gap-2">
